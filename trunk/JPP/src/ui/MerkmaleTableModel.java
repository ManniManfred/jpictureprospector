...
public class MerkmaleTableModel extends DefaultTableModel {
   ...
   * 
   * @param zeile
   *          Zeile der angegebenen Zelle
   * @param spalte
   *          Spalte der angegebenen Zelle
   ...
   * 
   * @param String
   *          Name des Merkmals, das abgefragt wird.
   ...
   * 
   * @param zeile
   *          Zeile der abgefragten Zelle
   * @param spalte
   *          Spalte der abgefragten Zelle
   ...
   * 
   * @param spaltenIndex
   *          Index der Spalte, dessen Klasse zurueckgegeben wird.
   ...
   *          neuer Wert
   * @param zeile
   *          Zeile der Zelle, in der der neue Wert gesetzt wird.
   * @param spalte
   *          Spalte der Zelle, in der der neue Wert gesetzt wird.
   */
   ...
   * 
   * @param zeile
   *          Zeile, fuer die abgefragt wird, ob der Wert editierbar ist.
