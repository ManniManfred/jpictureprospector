...
public class CheckboxTableCellRenderer implements TableCellRenderer {
   ...
   * 
   * @param tabelle
   *          Tabelle, die den Renderer aufruft
   * @param wert
   *          Inhalt der Tabellenzelle
   * @param istAusgewaehlt
   *          Gibt an, ob die angegebene Zelle ausgewaehlt ist.
   * @param hatFokus
   *          Gibt an, ob die angegebene Zelle fokussiert ist.
   * @param zeile
   *          Zeile der Zelle, deren Komponente geliefert wird.
   * @param spalte
   *          Spalte der Zelle, deren Komponente geliefert wird.
   * @return Komponente in der angegebenen Zelle.
   */
  public Component getTableCellRendererComponent(JTable tabelle, Object wert,
      boolean istAusgewaehlt, boolean hatFokus, int zeile, int spalte) {

    /*
     * Abhaengig davon, ob im Tabellenmodell angegebenen ist, dass diese Zeile
     * eine Checkbox enthaelt wird entweder eine Checkbox oder ein Label erzeugt
     */
   ...
   * 
   * @param component
   *          Komponente, deren Farbe gesetzt wird.
   * @param istAusgewaehlt
   *          Angabe, ob die angegebene Zelle ausgewaehlt ist.
   * @param hatFokus
   *          Gibt an, ob die angegebene Zelle fokussiert ist.
   * @param zeile
   *          Zeile der Zelle, deren Komponente geliefert wird.
